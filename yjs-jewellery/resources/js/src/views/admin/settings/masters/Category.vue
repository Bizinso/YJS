<template>
    <div class="listing_screen global_table_liting">
        <h2 class="masterHeading">Category</h2>
        <div class="listing_tab_and_actions mb-3">
            <div class="listing_actions">
                ...
                <div class="buttonGrid">
                    <b-button class="fillBTN" v-if="$can('do', 'add_admin.masters.categories')" @click="openAddSidebar">Add
                        Category</b-button>
                    ...
                    <div class="sidebar_form">
                        <b-form>
                            <div class="px-4 py-3 column_sidebar">
                                ...
                                <b-form-group>
                                    <b-form-input v-model="search.name" placeholder="Search by Category Name..." />
                                </b-form-group>
        ...
        <div v-else>
            ...
            <b-table responsive="sm" :items="paginatedData" :fields="fields" @sort-changed="onSortChanged"
                v-if="$can('do', 'list_admin.masters.categories') && paginatedData.length > 0">
                ...
                <template #cell(actions)="data">
                    ...
                    <b-dropdown right text="⋮" variant="link" no-caret toggle-class="p-0">
                        <b-dropdown-item v-if="$can('do', 'edit_admin.masters.categories')"
                            @click="openEditSidebar(data.item)">Edit</b-dropdown-item>

                        <b-dropdown-item v-if="$can('do', 'delete_admin.masters.categories')"
            ...
            <categoryNoData v-if="inqFilterStatus && paginatedData.length === 0 || !inqFilterStatus && sidebarstatus.filter" heading="No Records Found"
                subheading="Try adjusting your filters or search criteria." :showButton="false" />

            <categoryNoData v-else-if="paginatedData.length === 0 " heading="No Category Created Yet"
                subheading="You haven't added any category yet. Add your first category to get started."
                :showButton="$can('do', 'add_admin.masters.categories')" buttonText="Add Category" @button-clicked="openAddSidebar" />
...
import categoryNoData from "../../../components/noData.vue";
...
const changeSorting = (field) => {
    ...
    fetchCategory(); // Assuming fetchCategory is defined elsewhere
};
...
watch([currentPage, perPage], fetchCategory);
</script>
<style scoped>
.flipped-toggle {
